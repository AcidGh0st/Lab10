...
public class AdjacencyMatrixOperations {
    ...
    @javafx.fxml.FXML
    public void addEyWOnAction(ActionEvent actionEvent) {
        try {
            if (graph.size() < 2) {
    ...
    public void clearOnAction(ActionEvent actionEvent) {
        if (graph == null || graph.isEmpty()) {
            //Mostrar mensaje de error si la matriz está vacía o nula
            Alert alert = new Alert(Alert.AlertType.ERROR);
            alert.setTitle("Error");
            alert.setHeaderText(null);
            alert.setContentText("The Adjacency Matrix Graph is already empty.");
            alert.showAndWait();
        } else {
            graph.clear();
            textArea.clear();
            ...
            alert.setHeaderText(null);
            alert.setContentText("Adjacency Matrix Graph has been cleared.");
            alert.showAndWait();
            updateTextArea();
        }
    }
    ...
    public void addVertexOnAction(ActionEvent actionEvent) {
        try {
            Object vertex = util.Utility.getRandom(100); // Número aleatorio entre 0 y 99
    ...
    @javafx.fxml.FXML
    public void removeEyWOnAction(ActionEvent actionEvent) {
        try {
            if (graph.isEmpty()) {
